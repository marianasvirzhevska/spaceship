            ...
            <div className="content-wrapper">
                ...
                <h3>Це ваш бортовий компʼютер, який допомагатиме керувати кораблем та рятувальною космічною місією.</h3>
                    ...
                    <Fieldset legend="Батарея" toggleable>
                        <span><i className="pi pi-cog" style={{ fontSize: '2rem', color: '#e17100' }}></i></span> Для роботи корабля порібно вчасно замінювати батареї живлення. Нові батареї можна купити у магазині (вартість 5 токенів). 
                    ...
                    <Fieldset legend="Повітря" toggleable>
                        ...
                        Додаткові балони можна купити в магазині (вартість 3 токени).
